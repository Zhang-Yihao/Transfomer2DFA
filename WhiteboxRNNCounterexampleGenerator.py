...
class WhiteboxRNNCounterexampleGenerator:
    ...
    def _get_counterexample_from(self,words):
        ...
        for w in words:
            print(self.whiteboxrnn.classify_word(w),self.proposed_dfa.classify_word(w))
    ...
    def _process_new_state_except_children(self,new_cluster,new_info):
        ...
        if (not new_info.accepting == (new_info.dfa_state in self.proposed_dfa.F)) and new_info.dfa_state != '' :
